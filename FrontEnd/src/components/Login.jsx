    ...
    <div className='h-[calc(100vh-120px)] flex justify-center items-center '>
        <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
            ...
            <div className='mt-4'>
                ...
                className='w-full flex flex-wrap gap-1 items-center justify-center bg-cyan-400 hover:bg-purple-700 text-black font-bold py-2 px-4 rounded focus:outline-none'>
