  ...
  return (
    <div className='flex flex-col md:flex-row-reverse py-16 justify-between items-center gap-12'>
        ...
        <div className='md:w-1/2 w-full'>
            ...
            <button className='bg-purple-600 text-white  px-12 py-2 rounded-md text-base  font-bold hover:bg-cyan-500 hover:text-white transition-all duration-200 cursor-pointer'>Subscribe</button>
        </div>
